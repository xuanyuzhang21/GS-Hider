...
class GaussianModel:
    ...
    def get_semantic_feature(self):
        return torch.sigmoid(self._semantic_feature) 
    ...
    def random_initialize(self, spatial_lr_scale, num_pts=5000, radius=0.5):
        ...
        self.create_from_pcd(pcd, spatial_lr_scale, semantic_feature_size=16, speedup=False)
        return xyz, SH2RGB(shs)
